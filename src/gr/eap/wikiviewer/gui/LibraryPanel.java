...
public class LibraryPanel extends JPanel {
    ...
    public void loadLocalArticles() {
        ...
        // Καθάρισε το textbox αν έχει τιμή του local search καθώς  ψάχνουμε ανα κατηγορία.
    ...
    private void performKeywordSearch() {
        ...
        // Καθάρισε το dropdown μενού κατηγορίας, αν έχει τιμή του local search καθώς  ψάχνουμε ανα keyword σε local DB.
        // Βάλε το default "Όλες"

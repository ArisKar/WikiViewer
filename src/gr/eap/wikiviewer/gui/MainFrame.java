 ...
 * Περιέχει τα tabs: Search, Library , Αναζήτηση ΒΔ και Statistics.
 */
...
public class MainFrame extends JFrame {
    ...
    private LibraryPanel liblPanel;
    private StatisticsPanel statsPanel;
    private DatabaseSearchPanel dbSearchPanel;
    ...
    private void initComponents() {
        ...
        // Δημιουργία panels.
        srchPanel = new SearchPanel(this, wikiService, dbManager);
        liblPanel = new LibraryPanel(dbManager);
        statsPanel = new StatisticsPanel(dbManager, pdfService);
        dbSearchPanel = new DatabaseSearchPanel(dbManager);


        //Εφαρμογή του θέματος σε κάθε panel
        applyWikipediaTheme(srchPanel);
        applyWikipediaTheme(liblPanel);
        applyWikipediaTheme(statsPanel);
        applyWikipediaTheme(dbSearchPanel);

        // Προσθήκη tabs
        tabbedPane.addTab("<html><body style='color: rgb(51, 102, 204); font-weight: bold;'>Αναζήτηση [Live από API]</body></html>", srchPanel);
        tabbedPane.addTab("<html><body style='color: rgb(51, 102, 204); font-weight: bold;'>Αποθηκευμένα Άρθρα</body></html>", liblPanel);
        ...
        tabbedPane.addTab("<html><body style='color: rgb(51, 102, 204); font-weight: bold;'>Στατιστικά</body></html>", statsPanel);
    ...
    public void applyWikipediaTheme(JPanel panel) {
        ...
        for (Component c: panel.getComponents()) {
            ...
            if (c instanceof JButton){
                c.setFont(new java.awt.Font("SansSerif", java.awt.Font.BOLD, 12));
                c.setBackground(new java.awt.Color(18, 21, 28));
                c.setForeground(new java.awt.Color(51, 102, 204));
            }
        }
    }
}
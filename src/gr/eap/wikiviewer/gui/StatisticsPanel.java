...
public class StatisticsPanel extends JPanel {
    ...
    private BarPieChartWindow barPieChart;
    ...
    private void initComponents() {
        ...
        barPieChart = new BarPieChartWindow(dbManager);

        // Ενέργειες (Listeners)
        refreshBtn.addActionListener(e -> loadStats());
        pdfBtn.addActionListener(e -> exportStatsToPdf());
        newWindowBtn.addActionListener(e -> barPieChart.showWindow());
    ...
    private void exportStatsToPdf() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Τα στατιστικά δημιουργήθηκαν στον φάκελο " + new File(path).getAbsolutePath());
        } catch (Exception e) {
            //Σφάλμα.
